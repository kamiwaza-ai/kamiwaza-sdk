...
# ``Identity`` not in this set defaults to private. The bearer credential
# (``X-Auth-Token``) is deliberately not on the Identity model; see
# kamiwaza_extensions_lib.identity for the rationale.
