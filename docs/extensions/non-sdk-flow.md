...
| `X-User-Marking-Level` | string | Configured stable marking level ID. Not a boolean; enforcement remains server-side. |
...
extract_identity(headers):
  ...
  return Identity{
    ...
    marking_level:   headers.get("X-User-Marking-Level", ""),
