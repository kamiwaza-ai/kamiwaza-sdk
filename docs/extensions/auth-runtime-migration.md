...
`@kamiwaza-ai/extensions-lib@0.6.x` and
...
behavior is incompatible with the bootstrap-derived runtime path introduced in
0.5 and retained in 0.6.
...
The SDK's 0.6 runtime packages are the release gate for clean dependency
