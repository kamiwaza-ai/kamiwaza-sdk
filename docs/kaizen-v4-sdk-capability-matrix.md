...
3. Connector instance administration is in the SDK. The connector-surface
   ...
   adapters for that runtime path; the fresh-deployment runtime proof remains
   outstanding.
