...
Live integration test: exercises the full 7-step M3 demo flow against
...
binding via SDK, dataset creation via SDK.
Mirrors the README's seven-step walkthrough exactly.
...
def test_m3_full_walkthrough_against_live_fleet(
    ...
    Steps mirror README §"Federation walkthrough" exactly:
      ...
      5. Allowlist brokered user + ReBAC viewer grant
      6. Submit federated job via kz.jobs.run
      7. Assert audit_actor round-trip
    """
    import uuid
    ...
    with (
        ...
        try:
            ...
            assert subject.attributes["team"] == "BLUE"
            ...
            # Step 5 — Allowlist brokered user + ReBAC viewer grant on dataset.
            ...
            # Step 6 — Submit federated job. The demo's job script lives
            ...
            # Step 7 — Demo-gate assertion: audit_actor names the
